...
const Discount = () => {
  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 md:gap-10">
    ...
    <div className="w-full md:w-1/2 flex flex-col items-start text-left z-10">
      ...
      {/* Action Button */}
      <button className="group relative inline-flex items-center justify-center px-6 py-3 font-bold text-black transition-all duration-300 bg-white text-black rounded-full hover:bg-indigo-400 shadow-xl hover:scale-105 transform">
        Shop the Drop
        <svg 
    ...
    <div className="w-full md:w-1/2 relative flex justify-center items-center h-[400px] md:h-[600px] mt-12 md:mt-0">
