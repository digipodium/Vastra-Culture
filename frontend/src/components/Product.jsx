    ...
    <section>
      ...
      <div className="max-w-7xl mx-auto">
          <div>
            ...
            <h2 className="text-sm md:text-lg font-black text-indigo-500 uppercase tracking-tighter mt-2  pt-4">
              Trending Now
            </h2>

            <div className='w-full flex flex-wrap justify-evenly pt-4'>
              <div className='w-46 pt-8 flex flex-col items-center mb-12 '>
                <img className='w-50 ' src="image for product section.jpg" alt="t-shirt" />
              ...
              <div className='w-44  pt-8 flex flex-col items-center mb-12 '>
                <img className='h-68' src="image for product section 2.jpg" alt="t-shirt" />
                <p className='text-sm font-bold text-gray-500'>Urban Oversized T-shirt</p>
                <p className='text-xl font-bold '>799</p>
              </div>

              <div className='w-46 pt-8 flex flex-col items-center mb-12 '>
                <img className=' h-68' src="black t-shirt image for product section.webp" alt="t-shirt" />
                <p className='text-sm font-bold text-gray-500'>Unisex Oversized T-shirt</p>
                <p className='text-xl font-bold '>499</p>
              </div>

              <div className='w-46 pt-8 flex flex-col items-center mb-12 '>
                <img className='h-68' src="blue t-shirt image for product section.jpg" alt="t-shirt" />
            ...
            <div className='w-full flex flex-wrap justify-evenly pt-4'>
              <div className='w-46 pt-8 flex flex-col items-center mb-12 '>
                <img className='w-60 h-60 ' src="New_arrivals1.jpg" alt="t-shirt" />
                <p className='text-lg font-bold text-black pt-2'>Sneakers</p>
                {/* <p className='text-xl font-bold '>899</p> */}
              </div>

              <div className='w-44  pt-8 flex flex-col items-center mb-12 '>
                <img className='w-60 h-60 ' src="New_arrivals2.jpg" alt="t-shirt" />
                <p className='text-lg font-bold text-black pt-2'> Watches</p>
                {/* <p className='text-xl font-bold '>799</p> */}
              </div>

              <div className='w-46 pt-8 flex flex-col items-center mb-12 '>
                <img className='w-60 h-60 ' src="New_arrivals3.jpg" alt="t-shirt" />
