...
const Signup = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-100 py-10'>
            <div className="max-w-xl mx-auto bg-white border border-gray-200 rounded-xl shadow-2xs">
                {/* Sign In */}
                    ...
                    <div className="mt-5">
                        ...
                        <form onSubmit={signupForm.handleSubmit}>
                            <div className="grid gap-y-4">
                                {/* Form Group */}
                                <div>
                                    <label htmlFor="name" className="block text-sm mb-2 text-gray-800">full Name
                                    </label>
                                    <div className="relative">
                                        <input type="text"
                                            ...
                                            className="py-2.5 sm:py-3 px-4 block w-full bg-white border-gray-200 rounded-lg sm:text-sm text-gray-800 placeholder:text-gray-500 focus:border-blue-700 focus:ring-blue-700 disabled:opacity-50 disabled:pointer-events-none" aria-describedby="text-error" />
                                        <div className="hidden absolute inset-y-0 insert-e-0 pointer-events-none pe-3">
                                    ...
                                    </div>
                                    {
                                        (signupForm.errors.name && signupForm.touched.name) && (
                                            <p className="text-xs text-red-600 mt-2" id="text-error">{signupForm.errors.name}</p>
                                        )
                                    }
                                </div>
                                <div>
                                    ...
                                    </div>
                                    {
                                        (signupForm.errors.email && signupForm.touched.email) && (
                                            <p className="text-xs text-red-600 mt-2" id="text-error">{signupForm.errors.email}</p>
                                        )
                                    }
                                </div>
                                ...
                                <div>
                                    ...
                                    </div>
                                    {
                                        (signupForm.errors.password && signupForm.touched.password) && (
                                            <p className="text-xs text-red-600 mt-2" id="text-error">{signupForm.errors.password}</p>
                                        )
                                    }
                                </div>
                                {/* End Form Group */}
                                ...
                                <div>
                                    ...
                                    </div>
                                    {
                                        (signupForm.errors.confirmPassword && signupForm.touched.confirmPassword) && (
                                            <p className="text-xs text-red-600 mt-2" id="text-error">{signupForm.errors.confirmPassword}</p>
                                        )
                                    }
                                </div>
                                {/* End Form Group */}
